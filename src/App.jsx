...
function App() {
  return (
    ...
    <a href="#" className="btn-social x-btn">𝕏  Look on X</a>
  </div>
      </section>
        ...
        <div className="footer-content">
          ...
          <div className="footer-center">
            <div className="contract-box">
              ...
              <code className="contract-addr">0x927175552E5B9CD453d4C2F4B6a0f4CF61678cd0</code>
              <button className="copy-icon" onClick={() => navigator.clipboard.writeText("0x927175552E5B9CD453d4C2F4B6a0f4CF61678cd0")}>
                📋
              </button>
            </div>
          </div>

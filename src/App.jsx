...
function App() {
  return (
    ...
    <a href="https://opensea.io/collection/the-devils-gift-956814849" className="btn-social opensea-btn">👀 Look on OpenSea</a>
    <a href="https://x.com/thedevilsgift_?s=21&t=xns0V8hd-CUp7BPu4ErJmQ" className="btn-social x-btn">𝕏  Look on X</a>
  </div>
      </section>
